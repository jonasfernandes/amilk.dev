...
export default function Hero({ profile }: { profile: Profile | SSRError }) {
  ...
  return (
    <div className='flex flex-row px-4 py-8 sm:px-8 sm:py-16 lg:p-16 items-center gap-12 sm-gap-8 lg:gap-12 w-full lg:max-w-[1024px] mx-auto'>
      ...
      <div className='w-[100%] sm:w-[60%]'>
        <p className='p-2 text-foreground-2 text-xl'>Yo! <SaluteHand />, I’m <b>{profile.name}</b></p>
